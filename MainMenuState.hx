...
class MainMenuState extends MusicBeatState
{
  ...
  override function create():Void
  {
    ...
    //createMenuItem('merch', 'mainmenu/merch', selectMerch, hasPopupBlocker); i hid merch because it looks kinda wierd, but you can show it idc
    #end
    ...
    this.rightWatermarkText.text = "Creamy Engine v0.2.1A";
