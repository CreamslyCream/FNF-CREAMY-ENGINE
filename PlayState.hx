...
class PlayState extends MusicBeatSubState
{
  ...
  **/
  ...
  // the flxtext that diplays misses #
  ...
  function initHealthBar():Void
  {
    ...
    add(scoreText);
    // themiss text below the health bar
    missText = new FlxText(healthBarBG.x + healthBarBG.width - 290, healthBarBG.y + 30, 0, '', 20);
  ...
  function updateMissText():Void
  {
    if (isBotPlayMode)
    {
      missText.text = 'Bot Play Enabled';
    }
    else
    {
